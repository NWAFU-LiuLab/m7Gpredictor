...
#        feature_vector.extend(fea_vec1[i]+fea_vec2[i]+ssc(sequence))
        feature_vector.extend(fea_vec1[i]+fea_vec2[i])
#        feature_vector.extend(fea_vec2[i])
        sequence=line.replace('\n','')
        feature_vector.extend(kmer(sequence)+ksnpf(sequence)+npf(sequence))
#        feature_vector.extend(npf(sequence)+kmer(sequence))
...
#    print('AdaBoostClassifier Accuracy:%s'%ACC)
#    print('AdaBoostClassifier AUC:%s'%roc_auc)
#    print('AdaBoostClassifier Sensitive:%s'%Sn)
#    print('AdaBoostClassifier Specificity:%s'%Sp)
#    print('AdaBoostClassifier F1:%s'%F1)
#    print('AdaBoostClassifier MCC:%s'%MCC)    
##    aucm=0
#    gm=0
#    cm=0
...
#    print(cm)
#    print('SVM MCC:%s'%MCC)  
    clf = SVC(C=1.08,gamma=0.002,probability=True)
    clf.fit(X_train,y_train)
    print clf.score(X_test,y_test)
    predict_y_test = clf.predict(X_test)
